...
class get_audio():
    def __init__(self):
        ...
        self.project_name = '/home/zmx/catkin_ws/src/kamerider_speech/sounds/res_record/res'
        self.count = 0
    ...
    def play_signale_sound(self):
        chunk = 1024
        # 打开 .wav 音频文件
        f = wave.open('/home/zmx/catkin_ws/src/kamerider_speech/sounds/question_start_signal.wav', 'rb')
        # 初始化pyaudio
        p = pyaudio.PyAudio()
        # 打开一个stream
        stream = p.open(
