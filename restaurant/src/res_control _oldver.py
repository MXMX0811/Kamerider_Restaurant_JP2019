...
class restaurant(object):
    ...
    def __init__(self):
        ...
        self.objects = ['cola','juice','tea','pringles','olive','soup','cookies','biscuits','beans']
        self.object = ''
        self.is_stop            = False
        self.is_start           = False
    ...
    def xfeiCallback(self, msg):
        ...
        for obj in self.objects:
            if obj in output:
                self.object = obj
        # 添加误识别
        if 'juice' in output or 'grape' in output or 'grey' in output:
        ...
        elif 'or' in output or 'leave' in output or 'live' in output:
            self.object = 'olive'
        # 未获得结果
        if self.object == '':
